...
module RoboCompObjectDetection
{
	...
	interface ObjectDetection
	{
		...
		void saveCanonPose(string label, int numPoseToSave, pose6D tag1, pose6D tag2, pose6D tag3, pose6D tag4, pose6D tag5, pose6D tag6, pose6D tag7, pose6D tag8, pose6D tag9);
		void saveRegPose(string label, int numPoseToSave, pose6D tag1, pose6D tag2, pose6D tag3, pose6D tag4, pose6D tag5, pose6D tag6, pose6D tag7, pose6D tag8, pose6D tag9);
