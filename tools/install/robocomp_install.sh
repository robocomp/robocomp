...
sudo DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends git git-annex cmake cmake-qt-gui make g++ libgsl-dev libopenscenegraph-dev freeglut3-dev libxt-dev libboost-system-dev libboost-thread-dev libboost-test-dev libboost-filesystem-dev libqt4-dev libqt4-opengl libqt4-opengl-dev python-pip python-pyparsing=2.2.0+dfsg1-2 python-numpy python-pyside pyside-tools python-libxml2 python-xmltodict libccd-dev libzeroc-ice3.7 libzeroc-icestorm3.7 zeroc-ice-slice zeroc-ice-utils zeroc-icebox zeroc-ice-all-dev python-zeroc-ice  python-setuptools
