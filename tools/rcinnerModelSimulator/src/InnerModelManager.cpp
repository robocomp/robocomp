...
{
    ::std::pair< const ::std::string*, const ::std::string*> r = ::std::equal_range(__RoboCompInnerModelManager__InnerModelManager_all, __RoboCompInnerModelManager__InnerModelManager_all + 24, current.operation);
    if(r.first == r.second)
    {
