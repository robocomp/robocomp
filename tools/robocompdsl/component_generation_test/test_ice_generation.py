...
class ComponentGenerationChecker:
    ...
    def statistical_compare_ice(self, first_file, second_file, output_dir):
        """
                ...
                if code == 0:
                    ...
                    if generate_only:
                        ...
                        if os.path.isfile(original_ice_file):
                            n_diff_lines, diff_lines, deprecated = self.statistical_compare_ice(original_ice_file, ice_path, output_dir)
...
if __name__ == '__main__':
    ...
    try:
        ...
        checker.check_components_generation(args.indir, args.dry_run, args.dirty, outdir, args.generate_only,
