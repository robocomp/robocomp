...
if __name__ == '__main__':
	...
	try:
		...
		# Create a proxy to publish a publishTest topic
		topic = False
		try:
			topic = topicManager.retrieve("publishTest")
		except:
			pass
		while not topic:
			try:
				...
				try:
					topic = topicManager.create("publishTest")
				except:
					print 'Another client created the publishTest topic? ...'
		pub = topic.getPublisher().ice_oneway()
		publishtestTopic = publishTestPrx.uncheckedCast(pub)
		mprx["publishTestPub"] = publishtestTopic
