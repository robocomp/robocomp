...
class MainClass(QtGui.QMainWindow, CustomMainWindow):
    ...
    # This will set and draw all the directory components+I have added the job of defining a connection in here
	def setDirectoryItems(self):
		for x in self.componentList.__iter__():
	...
	def addNewComponent(self,
						pos=QtCore.QPointF()):  # The final function which takes care of adding new component default zero
