...
from PySide.QtGui import QMainWindow, QApplication, QVBoxLayout, QWidget, QTextEdit, QListWidget, QComboBox, \
	QPushButton, QLineEdit, QHBoxLayout, QSplitter, QCompleter, QFileSystemModel, QAbstractItemView, QLabel, \
	QFileDialog, QMessageBox, QInputDialog, QCheckBox, QColor, QFont, QPalette
