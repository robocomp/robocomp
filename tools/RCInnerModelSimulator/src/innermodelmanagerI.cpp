...
bool InnerModelManagerI::setPose(const std::string& item, const std::string& base, const RoboCompInnerModelManager::Pose3D& pose, const Ice::Current&)
{
	return worker->imm_setPose(id, item, base, pose);
}
...
bool InnerModelManagerI::getPose(const std::string& item, const std::string& base, RoboCompInnerModelManager::Pose3D& pose, const Ice::Current&)
{
	return worker->imm_getPose(id, item, base, pose);
}
...
bool InnerModelManagerI::transform(const std::string& item, const std::string& base, const coord3D& coordInItem, coord3D& coordInBase, const Ice::Current&)
{
	return worker->imm_transform(id, item, base, coordInItem, coordInBase);
}

Matrix InnerModelManagerI::getTransformationMatrix(const std::string& item, const std::string& base, const Ice::Current&)
{
	return worker->imm_getTransformationMatrix(item, base);
}
