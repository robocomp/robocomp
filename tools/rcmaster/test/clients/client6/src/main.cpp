...
/** \mainpage RoboComp::client6
 *
 * \section intro_sec Introduction
 *
 * The client6 component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/client6 --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class client6 : public RoboComp::Application
{
public:
	client6 (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::client6::run(int argc, char* argv[])
{
	...
	mprx["testProxy1"] = (::IceProxy::Ice::Object*)(&test1_proxy);


	ifaces["test2"] = ifaceData("test2","test","client31");
	while (true)
	{
		try
		{
	...
	mprx["testProxy2"] = (::IceProxy::Ice::Object*)(&test2_proxy);
