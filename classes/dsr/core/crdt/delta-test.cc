...
struct data {
    ...
    friend ostream &operator<<(ostream &output, const data &o) {
        output << "ID: " << o.id << ". OP_PUNTERO:" << o.op_puntero << ". OP: " << o.op << " --";
        return output;
    }
...
// --------------------------------------------------------------------------
    ...
    gset<data> s0, s1, t0, t1;

    t0 = s0.add(d1);
    t1 = s0.add(d2);
    cout << "GSET0:" << s0.read() << endl;
    cout << "delT0:" << t0.read() << " delT1:" << t1.read() << endl;
    s1.add(d3);
    s1.add(d4);
    cout << "GSET1:" << s1.read() << endl;
    cout << s1.read().size() << endl;
...
//    // o6 seria comp A
//    o6.add("esteban");
//    // esteban es lo que me llega
//    // o5 seria comp B
//    // oAux es el auxiliar para "contextualizar"
//
//    oAux.add("esteban"); // Tiene contexto que no me vale.
//    cout <<"oAux "<<  oAux << endl;
//    oAux.add("esteban"); // Tiene contexto que no me vale.
//    cout <<"oAux "<<  oAux << endl;
//    oAux.context().setContext("idz", 5-1, 0); // Le pongo contexto adecuado.
//    cout <<"oAux "<<  oAux << endl;
//    delta = oAux.add("esteban"); // Se añade con context correcto
//    cout <<"oAux "<<  oAux << endl;
//    o5.join(delta);
//    cout <<"o6 "<<  o6 << endl;
//    cout <<"o5 "<< o5 << endl;
//    printf("Time taken: %.2fs\n", (double)(clock() - tStart)/CLOCKS_PER_SEC);
    ...
    cout << "----------- MOD2 " << endl;
    aworset<string> delta;
    aworset<string> nodesA("user");
    aworset<string> nodesB("visitor");
    aworset<string> aux("visitor");

    cout << "nodesA: " << nodesA << endl;
    cout << "nodesB: " << nodesB << endl;
    cout << "----------------" << endl;
...
void example3() {
    ...
    cout << "SET Y " << sy.read() << endl;
    cout << "DELTA Y " << dy.read() << endl;
    cout << "SET X " << sx.read() << endl;
...
void example_mvreg() {
    cout << "-- example mv_reg --" << endl;
    mvreg<string> x("uid-x"), y("uid-y");
    cout << "Empty " << x << endl;

    x.write("hello");
    x.write("world");
    cout << "Last world: " << x.read() << endl;

    cout << "X: (world)" << x << endl;
    y.write("world");
    y.write("hello");
    cout << "Hello -> " << y.read() << endl;
    cout << "Y (hello) " << y << endl;
    y.join(x);
    cout << "hello world " << y << endl;
    cout << "hello world --> " << y.read() << endl; // Output is ( hello world )


//     ------------ test replace
    cout << "---------------" << endl;
    mvreg<string> t("uid-z");
    mvreg<string> delta1 = t.write("mars");
    cout << "delta1" << delta1;
    y.join(delta1);
    cout << "mars joined to hello world --" << y << endl;
    mvreg<string> delta2 = t.write("mars1");
    y.join(delta2);
    cout << "mars1 joined to hello world?? --" << y << endl;

//     y.join(mvreg<string> ("uid-z").write("mars"));
//     cout << "mars joined to hello world --" << y << endl;
//     y.join(mvreg<string> ("uid-z").write("mars2")); //TODO
//     cout << "mars2 joined to x -- " << y << endl;
//      y.join(mvreg<string> ("uid-y").write("hello2")); //TODO
//     cout << "hello2 joined to x -- " << y << endl;
//     cout << "---------------" << endl;
...
//    m1.join(aux);
//    aux = ormap<string,aworset<string,string>> ("test");
//    aux["test"].add("testtttttttttt");
//    m1.join(aux);

//    aworset<string> aw2 ("test");
//    aw2.add("hola");
//    m1["test"] = aw2;
//    cout << m1 << endl;
//    aworset<string> aw3 ("test2");
//    aw3.add("hola2");
//    m1["test2"] = aw3;
//    cout << m1 << endl;
//    aworset<string> aw4 ("test4");
//    aw4.add("hola2");
//    m1["test4"] = aw4;
...
//      cout << "m1 " <<m1 << endl;
//      cout << "m2 " << m2 << endl;
//        for (auto d : m1["friend"].read())
//            cout << d << endl;
//
//    cout << m1["friend"].read()<< endl;
//
//    if (m1.in("friend2")) cout << "Está" << endl;
//    else cout << "No está" <<endl;
//
//    auto full = m1.getFullOrMap();
//    cout << full.first << endl;
//    cout << full.second.first["friend"] <<endl;
