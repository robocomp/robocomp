...
class TreeViewer(QTreeWidget):
    ...
    def createGraph(self, ):
        pass
    def create_attribute_widgets(self, QTreeWidgetItem* parent, Node* node):
        pass
    def create_attribute_widget(self, QTreeWidgetItem* parent, Node* node, std::string key, Attribute value):
        pass
    def update_attribute_widgets(self, Node* node):
        pass


    signals:
        void node_check_state_changed(newValue, id, type,  QTreeWidgetItem * item)
