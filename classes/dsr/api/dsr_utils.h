...
namespace DSR
{
    ...
    class Utilities
    {
        public:
            ...
            void read_from_json_file(const std::string &json_file_path, const std::function<std::optional<uint128_t>(const Node&)>& insert_node);
            ...
            void print_node(uint128_t id);
            void print_RT(uint128_t root);
