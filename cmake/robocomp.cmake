...
MACRO( ROBOCOMP_INITIALIZE )
  ...
  # Other libraries
  SET( LIBS ${LIBS} -L/opt/robocomp/lib ${OSG_LIBRARY} -losg -losgUtil -losgGA ${OSGDB_LIBRARY} ${OSGVIEWER_LIBRARY} ${OPENTHREADS_LIBRARY} -L${ROBOCOMP_ROOT}/classes  -lpthread -lboost_system ${QT_LIBRARIES} robocomp_qmat  ${Ice_LIBRARIES} robocomp_innermodel robocomp_osgviewer)
