...
MACRO( ROBOCOMP_INITIALIZE )
  ...
  SET( LIBS ${LIBS} -L/opt/robocomp/lib ${OSG_LIBRARY} -losgViewer -losg -losgUtil  -losgGA ${OSGDB_LIBRARY} ${OSGVIEWER_LIBRARY} ${OPENTHREADS_LIBRARY} -L${ROBOCOMP_ROOT}/classes ${CMAKE_THREAD_LIBS_INIT} -lIceStorm -lIce  -lboost_system  robocomp_qmat ${IPP_LIBS} robocomp_innermodel robocomp_osgviewer)
