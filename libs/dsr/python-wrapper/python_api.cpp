...
PYBIND11_MODULE(pydsr, m) {
    ...
    py::class_<DSRGraph>(m, "DSRGraph")
            ...
            .def("update_node", &DSRGraph::update_node<const DSR::Node&>, "node"_a, "Update the node in the graph. Returns a bool.")
            ...
            .def("get_edge",
                 ...
                 "Return the edge with the parameters from, to, and type passed as parameter.  If the edge does not exist it return None")
            .def("insert_or_assign_edge", [](DSRGraph &self, const DSR::Edge& e) { return  self.insert_or_assign_edge(e); },  "edge"_a,
